...
![](media/image12.jpg){width="0.8333333333333334in" height="0.5520833333333334in"}

[[APRIL DUNFORD]{.underline}](https://substack.com/@aprildunford)
...
![](media/image15.jpg){width="8.1in" height="3.763888888888889in"}
...
![](media/image14.png){width="8.1in" height="6.069444444444445in"}
...
![](media/image16.jpg){width="8.1in" height="3.8333333333333335in"}

[[In the sales structure I use]{.underline}](https://www.aprildunford.com/books), here's exactly how I handle this:

1.  **Guidance and persuasion are primary goals.** My sales story structure has a "setup" phase that gives the rep a way to help customers understand our point of view on the market and the pros and cons of alternative ways to solve the problem. This allows the rep to offer proactive guidance to the prospect by painting a picture of the entire market so that they can make better choices.

2.  **A defined spot for discovery** - Step 2, the "alternatives" step of my sales pitch structure, is designed to have a conversation about the market, but it is also the perfect opportunity for a rep to do discovery. How is the customer currently solving the problem? What else has the customer tried? What other solutions is the customer looking at? What are the customer constraints? Step two gives reps a very natural place to work through these questions.

3.  **A flexible format** - My structure has several places where a rep can make on-the-fly changes to ensure the story resonates with the prospect. Step 6, or the "Proof" step, is often done with a case study. Many companies that use my structure will have a library of case studies so that the rep can use one that matches the prospect's situation most closely. Step 7 is an optional step for handling unspoken objections. Again, many companies will have a pre-built set of objections that a rep can pull from depending on the prospect's situation.

4.  **A focus on the immediate timeframe** - This sales structure is based on the company's current positioning. The heart of the pitch is the company's differentiated value. Put another way, it is centered on the answer to the question, "Why pick us over the other alternatives?" This isn't a theoretical strategy question or a fuzzy vision of the future that may or may not come to pass. This is firmly centered on how you beat today's competitors with today's product.

5.  **Designed specifically for prospects in a purchase process** - Because positioning is the starting point for the sales pitch, it is designed specifically with your best-fit prospects in mind.

6.  **Designed to accommodate interaction** - A good salesperson will naturally make a pitch interactive, but it helps to have a sales pitch structure designed with that interaction in mind. As already mentioned, the "Alternatives" step was designed for a discovery conversation. The "Perfect World" step is designed to get alignment with the customer about our point of view on the world. Step 7, the "Objections" step, is designed to be a conversation around objections. The final step, "the Ask," is a conversation about what steps we jointly agree to take next.

[[My new book, Sales Pitch, gets into the gory details of the structure]{.underline}](https://www.amazon.com/Sales-Pitch-Craft-Story-Stand/dp/1999023021/). If you want to go deeper, you can start there.
...
**An online explainer or walkthrough video** - it would make sense that this would follow a similar structure to your sales pitch. Here's one from [**[Pantheon]{.underline}**](https://pantheon.io/demo/content) (signup required, sorry!)

**A buyer's guide** - Customers crave insight into how they should evaluate products, and we are in a perfect position to give it to them. The "setup" part of the sales pitch gives us everything we would need to create a buyer's guide. **[[Here's a guide from Gearset]{.underline}](https://gearset.com/resources/enterprise-ebook/)** and not exactly a buyer's guide, but close, from [**[Help Scout]{.underline}**](https://www.helpscout.com/helpu/customer-service-roi/).

**The "point of view" whitepaper or guide** - The setup part of the sales pitch is designed to communicate the company's point of view on a market. It makes sense that we would have content that goes deeper into why we look at the market the way we do. Here's an example from [**[M-Files]{.underline}**](https://www.m-files.com/unlocking-the-value-of-knowledge-work-automation/) and another from [**[Postman]{.underline}**](https://www.postman.com/api-first/), and another from [**[Checkr]{.underline}**](https://checkr.com/company/mission).

**The founder/CEO conference or media talk** - We never want to be selling from the stage, but our market insight makes a great topic for a conference talk, and I've seen many founders make good use of that. Here's the CEO of [**[Checkr]{.underline}**](https://www.youtube.com/watch?app=desktop&v=wEnEDfSuTQY) talking on Bloomberg. Here's the CEO of [**[GeoComply]{.underline}**](https://www.youtube.com/watch?v=bp5XjLrpNTU) at Websummit.

In [**[my work]{.underline}**](https://www.aprildunford.com/consultant) with companies, we work through the positioning and then build a sales story that mirrors that. I started doing that because I felt that a live sales pitch was the best way for B2B companies to test their positioning. I've now seen the additional benefit on the marketing side of the house. It's much easier to start with a sales story and work backward to marketing than attempting to do the opposite.

What do you think? Sound off in the comments!

[Leave a comment](https://aprildunford.substack.com/p/sales-first-storytelling/comments)

I wrapped up Season One of my podcast, **[[Positioning with April Dunford]{.underline}](https://www.positioning.show/).** If you missed it, you can [**[binge-watch/listen here]{.underline}**](https://www.positioning.show/). Do you have any topics you would like me to cover in Season Two? Let me know in the comments.

I appreciate all of you who have subscribed! This newsletter is pretty new, but I'm having fun with it so far. Thanks for reading!

April

Subscribed

![Positioning with April Dunford](media/image4.jpg){width="0.5694444444444444in" height="0.5694444444444444in"}

### Recommend Positioning with April Dunford to the readers of the grumpy writer
...
![](media/image13.jpg){width="0.8333333333333334in" height="0.75in"}

![](media/image6.png){width="0.8333333333333334in" height="0.8333333333333334in"}

![](media/image9.jpg){width="0.8333333333333334in" height="0.8333333333333334in"}

![](media/image8.jpg){width="0.8333333333333334in" height="0.8333333333333334in"}

![](media/image2.jpg){width="0.8333333333333334in" height="0.8333333333333334in"}

46 Likes

·

[6 Restacks](https://substack.com/note/p-139253677/restacks?utm_source=substack&utm_content=facepile-restacks)
...
![](media/image1.jpg){width="0.6666666666666666in" height="0.6666666666666666in"}

+------------------------------------------------------------------------------------+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| ![](media/image10.png){width="0.6944444444444444in" height="0.6944444444444444in"} | **Peter**                                                                                                                                                                                                                                                                                                                                                                                                                                  |
|                                                                                    |                                                                                                                                                                                                                                                                                                                                                                                                                                            |
|                                                                                    | [Feb 20](https://aprildunford.substack.com/p/sales-first-storytelling/comment/49954576)Liked by April Dunford                                                                                                                                                                                                                                                                                                                              |
|                                                                                    |                                                                                                                                                                                                                                                                                                                                                                                                                                            |
...
**1 reply by April Dunford**

+------------------------------------------------------------------------------------+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| ![](media/image10.png){width="0.6944444444444444in" height="0.6944444444444444in"} | **Colleen Pimentel**                                                                                                                                                                                                                                                                                                     |
|                                                                                    |                                                                                                                                                                                                                                                                                                                          |
|                                                                                    | [Nov 29, 2023](https://aprildunford.substack.com/p/sales-first-storytelling/comment/44482905)Liked by April Dunford                                                                                                                                                                                                      |
|                                                                                    |                                                                                                                                                                                                                                                                                                                          |
...
[[A Guide to Positioning with Multiple Products, Segments and Personas]{.underline}](https://aprildunford.substack.com/p/a-guide-to-positioning-with-multiple)

[[I am frequently asked about how we handle positioning where we have multiple products, serving multiple market segments, and being bought by a range of...]{.underline}](https://aprildunford.substack.com/p/a-guide-to-positioning-with-multiple)

NOV 1, 2023 • [APRIL DUNFORD](https://substack.com/@aprildunford)

![](media/image7.jpg){width="3.3333333333333335in" height="2.21875in"}

57

16

[[A Buyer-Centric Approach to Competitive Positioning]{.underline}](https://aprildunford.substack.com/p/a-buyer-centric-approach-to-competitive)

[[In positioning work, we need to understand the competitive landscape or what we need to position against. In my opinion, many companies get this wrong...]{.underline}](https://aprildunford.substack.com/p/a-buyer-centric-approach-to-competitive)

NOV 14, 2023 • [APRIL DUNFORD](https://substack.com/@aprildunford)

![](media/image3.png){width="3.3333333333333335in" height="2.21875in"}

51

12

[[Understanding the Job of a Market Category]{.underline}](https://aprildunford.substack.com/p/understanding-the-job-of-a-market)

[[Market Category is important, but it is not the core of our positioning. Many companies think that positioning starts with choosing a market category...]{.underline}](https://aprildunford.substack.com/p/understanding-the-job-of-a-market)

JAN 11 • [APRIL DUNFORD](https://substack.com/@aprildunford)

![](media/image5.jpg){width="3.3333333333333335in" height="2.21875in"}
